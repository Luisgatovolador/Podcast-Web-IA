...
function MediaControlCard({ title, subtitle, image }) {
  ...
  return (
    <Card sx={{ display: "flex", alignItems: "center", mt: 2, bgcolor: "#3e3e3e", color: "#fff" }}>
      <Box sx={{ display: "flex", flexDirection: "column", flex: 1, pl: 2 }}>
        ...
        <Box sx={{ display: "flex", alignItems: "center", pl: 1, pb: 1 }}>
          ...
          <IconButton aria-label="play/pause" sx={{ color: "#fff" }}>
...
export default function App() {
  ...
  return (
    <>
      ...
      <Container maxWidth="md" sx={{ py: 6 }}>
        <Typography variant="h3" align="center" gutterBottom sx={{ color: "#0a0a0aff" }}>
  ...
  {cards.map((card) => (
    <Grid
      ...
      sm={6}       // 2 por fila en pantallas medianas y grandes
      display="flex"
